<?php
	...
	shell_exec('C:/xampp/htdocs/Testbot.exe 1.cpp	ABC');
	...
	{	
		...
		if ((strlen($nazwakonta)<1) || (strlen($nazwakonta)>64)) //długość hasła od 8 do 25
		{
			$DanePoprawne1=false;
			$_SESSION['e_nazwakonta']='<span class="error">Nazwa musi mieć od 1 do 64 znaków!</span><br/><br/>';
		}
